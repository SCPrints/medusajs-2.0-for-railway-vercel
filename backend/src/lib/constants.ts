...
/**
 * Admin CORS origins
 * Fallback to empty string to prevent undefined errors in config
 */
 ...
 * This is the critical variable for your Vercel connection
 */
...
/**
 * (optional) SendGrid API Key and from Email
 */
