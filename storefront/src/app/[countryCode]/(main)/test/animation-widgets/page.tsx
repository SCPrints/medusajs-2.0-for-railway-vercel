...
export async function generateMetadata({
  ...
  const description =
    "Internal lab page for motion and UI experiments (10 sections per page): embeds, particles, Tier A/B/C/D catalog, five Rive presets (local .riv), stippled particle type, five Spline slots, WebGL, plus button labs. Use ?page=2, etc."
      ...
      <div className="bg-ui-bg-subtle border-b border-ui-border-base">
        <div className="content-container py-8 small:py-10">
          ...
          <p className="mt-2 max-w-2xl text-ui-fg-muted text-sm small:text-base">
            ...
            start around page 13 (see footer pagination). The old{" "}
