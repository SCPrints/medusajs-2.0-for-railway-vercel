...
const DesktopMegaMenu = ({ audiences }: Props) => {
  ...
  return (
    ...
    >
            ...
            return (
              ...
              >
                <LocalizedClientLink
                  ...
                  className={[
                    "inline-flex items-center px-4 py-3 text-sm font-medium tracking-wide",
      ...
      {/* Dropdown panel — single panel that swaps content as the user hovers
          between audience triggers. Positioned absolute below the nav row;
          full viewport width so columns can spread out. */}
      {activeAudience ? (
        <div
          ...
          onMouseLeave={scheduleClose}
        >
          {/* Decorative connector + drop-shadow panel */}
