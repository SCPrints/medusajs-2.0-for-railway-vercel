...
- Minimum ${SCREEN_MIN_QUANTITY} pieces. Quantity bands apply per JOB (same garment + same artwork) — other items in the order don't move a screen job into a cheaper band.
